# -*- coding: utf-8 -*-
"""G_Type_Habitable.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1bGDGJo5cyyNztvDLO8P-Si51jffxlApr
"""
            ...
            if ('Transit' in planet['discoverymethod']):
                if (planet['pl_orbeccen'] <= 0.2):
                    if (np.abs(float(planet['pl_orbper']) - float(control_planet['pl_orbper'])) <= 50):
                        ...
                        g_type_habitable = g_type_habitable.append(planet, ignore_index=True)
